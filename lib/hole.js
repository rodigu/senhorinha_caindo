class Hole extends Road {
  ...
  setHoleType(holeID) {
    ...
    if (holeIDNum < 3) this.size = { width: Hole.SMALL, height: UNIT_SIZE };
    else if (holeIDNum < 6)
      this.size = { width: Hole.SMALL * 2, height: Hole.SMALL * 2 };
    else this.size = { width: Hole.SMALL * 3, height: Hole.SMALL * 3 };
  }
