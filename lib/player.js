class Player extends Entity {
  ...
  static createPlayer(manager) {
    ...
    const heartTiles = new Tileset({
      ...
      originalTileWidth: gameManager.assetsConfig.coracao.largura,
      originalTileHeight: gameManager.assetsConfig.coracao.altura,
      tilesetColumns: 2,
      tilesetRows: 1,
      canvasTileSize: UNIT_SIZE,
      xZero: 0,
    ...
    car.addState("default", (c) => {
      ...
      // for (const p of c.collision.points()) circle(p.x, p.y, 10);
